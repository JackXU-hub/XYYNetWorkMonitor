...
extern NSString *XYYDATA_KEY_RESPONSEDATA; //返回包（状态为失败时记录）
extern NSString *XYYDATA_KEY_ORIGINALMD5; //原始md5信息
extern NSString *XYYDATA_KEY_DOWNLOADMD5; //下载成功文件的md5信息
extern NSString *XYYDATA_KEY_ORIGINALSIZE; //原始文件大小
extern NSString *XYYDATA_KEY_DOWNLOADSIZE; //下载成功文件的文件大小
extern NSString *XYYDATA_KEY_REALDOWNLOADSIZE; //实际下载大小（md5不一致时记录）
